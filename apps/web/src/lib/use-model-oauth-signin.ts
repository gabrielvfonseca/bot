import type { ModelOAuthBegin } from "@bot/contracts";
import { cancelModelOAuthAttempt, finishModelOAuthAttempt } from "@bot/core";
  ...
  async function startSubscriptionSignIn(begin: ModelOAuthSignInBegin) {
    ...
    try {
      ...
      if (browserAuth?.open) {
        ...
        window.open(started.verificationUri, "bot-model-oauth", "noopener,noreferrer");
      }
