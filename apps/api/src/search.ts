import type { Actor, MessageBlock, SearchHit } from "@bot/contracts";
import { extractLinksFromText, matchesSearchQuery, snippetAroundMatch } from "@bot/core";
import { Prisma, type PrismaClient } from "@bot/database";
