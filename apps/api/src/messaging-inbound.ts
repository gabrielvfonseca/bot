import type { JobPublisher, MessagingInboundMessage } from "@bot/adapter-kit";
import { messagingDeliverJob, runContinueJob } from "@bot/adapter-kit";
import type { MessageBlock } from "@bot/contracts";
import { parseMessagingCommand, sanitizeMessagingLabel } from "@bot/core";
import type {
      ...
      data: [
        {
          ...
          body: "Hi. This line hosts Bot personal agents. Some people in this group haven't messaged it yet; send any message to this line first if you want your own agent here.",
        },
      ],
      skipDuplicates: true,
    });
    ...
    data: [
      {
        ...
        body: `"${name}" was linked to your Bot agent. Reply YES to let your agent join the conversation there, or NO to stay out.`,
      },
    ],
    skipDuplicates: true,
  });
