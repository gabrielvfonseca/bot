export const RU_MESSAGES: Record<string, string> = {
  ...
  "Enter your Bot server address.": "Введите адрес вашего сервера Bot.",
  "Show less": "Свернуть",
  Members: "Участники",
  ...
  "Point this app at your self-hosted Bot origin, the same HTTPS URL you open in a browser.":
    "Направьте это приложение на свой собственный источник Bot, тот же URL-адрес HTTPS, который вы открываете в браузере.",
  Private: "Личный",
  ...
  "Sign in": "Войти",
  "Sign in to Bot": "Войти в Bot",
  "Sign out": "Выйти",
  "Sign up": "Зарегистрироваться",
  "Sign up for Bot": "Зарегистрироваться в Bot",
  "Sign-in": "Вход",
  "Sign-up": "Регистрация",
  ...
  "That URL did not look like a Bot server": "Этот адрес не похож на сервер Bot",
  ...
  "Paste the OpenAI-compatible address from your server. Bot adds /v1 if needed.":
    "Вставьте OpenAI-совместимый адрес со своего сервера. При необходимости Bot добавляет /v1.",
  ...
  "This subscription sign-in is not available in Bot yet. Use a deployment credential or choose another provider.":
    "Вход по этой подписке пока недоступен в Bot. Используйте учётные данные развёртывания или выберите другого провайдера.",
