export const ZH_MESSAGES: Record<string, string> = {
  ...
  "Enter your Bot server address.": "输入你的 Bot 服务器地址。",
  "Show less": "收起",
  Members: "成员",
  Max: "最高",
  Minimal: "最低",
  ...
  "Point this app at your self-hosted Bot origin, the same HTTPS URL you open in a browser.":
    "将此应用指向你自托管的 Bot 源站，地址与你在浏览器中打开的 HTTPS URL 相同。",
  Private: "私有",
  Providers: "提供商",
  ...
  "Show {label}": "显示 {label}",
  "Sign in": "登录",
  "Sign in to Bot": "登录 Bot",
  "Sign out": "退出登录",
  "Sign up": "注册",
  "Sign up for Bot": "注册 Bot",
  "Sign-in": "登录",
  "Sign-up": "注册",
  ...
  "That URL did not look like a Bot server": "该地址看起来不是 Bot 服务器",
  ...
  "Paste the OpenAI-compatible address from your server. Bot adds /v1 if needed.":
    "粘贴你服务器的 OpenAI 兼容地址。如有需要，Bot 会自动补上 /v1。",
  Paused: "已暂停",
  Prompt: "提示词",
