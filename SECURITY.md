...
Email **security@bot.com** only. Do not open public GitHub issues for security bugs.
...
- General support: **support@bot.com**
- Maintainer: **elie@bot.com**

## Scope

This policy covers the Bot self-hosted product in **this repository**.
