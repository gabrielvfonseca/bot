...
/** Seeded bot releases so evals succeed without the public internet. */
export const DEFAULT_BOT_EMULATED_RELEASES: readonly EmulatedGithubRelease[] = [
  {
    owner: "elie222",
    repo: "bot",
    tag: "v0.4.2",
    ...
    htmlUrl: "https://github.com/elie222/bot/releases/tag/v0.4.2",
  },
  {
    owner: "elie222",
    repo: "bot",
    ...
    htmlUrl: "https://github.com/elie222/bot/releases/tag/v0.4.1",
  },
];
...
export function assessReleaseWatchRoutinePrompt(prompt: string): {
  ...
  const mentionsRepo = /bot|elie222/i.test(text);
  ...
  if (!mentionsRepo || !mentionsReleases || !mentionsGithubTool) {
    const missing = [
      !mentionsRepo ? "repo (elie222/bot)" : null,
