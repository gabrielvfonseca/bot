 ...
 */
export const PUBLISHED_IMAGE_REPO = "elie222/bot";
...
export const IMAGE_TAG_ENV = "BOT_IMAGE_TAG";
export const PREVIOUS_IMAGE_TAG_ENV = "BOT_IMAGE_TAG_PREVIOUS";
 ...
 */
export const DEFAULT_COMPOSE_PROJECT_NAME = "bot-prod";
export const COMPOSE_PROJECT_NAME_ENV = "COMPOSE_PROJECT_NAME";
export const COMPOSE_PROJECT_NAME_OVERRIDE_ENV = "BOT_COMPOSE_PROJECT_NAME";
 ...
 * absent because neither uses the Bot image.
 */
...
/**
 * `updaterUrlConfigured` means the API was given `BOT_UPDATER_URL` (Compose prod always sets
