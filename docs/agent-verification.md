...
Bot separates deterministic execution regressions from real-model task quality.
...
stream through Bot's existing generic connection. It does not replace Pi.
...
pnpm test:computer-replay --image=bot/computer:local
